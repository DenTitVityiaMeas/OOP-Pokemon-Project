...
compile: 
	rm -f main *.o
	g++ -std=c++11 -I C:\CPP\SFML-2.5.1-windows-gcc-7.3.0-mingw-64-bit\SFML-2.5.1\include -c main.cpp stdInclude.cpp WelcomeState.cpp TrainerName.cpp PokemonMenu.cpp Moves.cpp Pokemon.cpp firePokemon.cpp grassPokemon.cpp waterPokemon.cpp Pokemonlist.cpp BattleSystem.cpp Function.cpp
link:
	g++ -std=c++11 -L C:\CPP\SFML-2.5.1-windows-gcc-7.3.0-mingw-64-bit\SFML-2.5.1\lib .\main.o stdInclude.o WelcomeState.o TrainerName.o PokemonMenu.o Moves.o Pokemon.o firePokemon.o grassPokemon.o waterPokemon.o Pokemonlist.o BattleSystem.o Function.o -o main.exe -lsfml-graphics -lsfml-window -lsfml-audio -lsfml-network -lsfml-system
	./main.exe
clean:
	rm -f main *.o